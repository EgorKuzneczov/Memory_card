...
question_list.append(Question('Создатель компании Apple', 'Стив Джобс', 'Евгений Касперский', 'Тим Кук', 'Илон Маск'))
question_list.append(Question('Какого цвета нет во флаге России?', 'Зеленый', 'Красный','Белый','Синий'))
app = QApplication([])
...
def next_question():
    #window.cur_question = window.cur_question + 1 больше не нужен
    window.total += 1
